...
import { useGetHelloByNameQuery } from "@store/api";
...
function App() {
  ...
  console.log(`FE_VERSION: ${import.meta.env.FE_VERSION}`);
  return (
    <>
      <div>
        ...
        <a href="https://redux-toolkit.js.org/" target="_blank">
          <img
            src={reduxLogo}
            className={classNames(styles["logo"], styles["redux"])}
            alt="Redux logo"
          />
        </a>
        <a href="https://docs.nestjs.com/v" target="_blank">
          <img
            src={nestLogo}
            className={classNames(styles["logo"], styles["nest"])}
            alt="Nest logo"
          />
        </a>
      </div>
      ...
      <div className={styles["card"]}>
        ...
        <p>
          This is a message from backend: "<b>{data?.message}</b>"
        </p>
        <p>
